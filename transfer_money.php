        ...
        <div id="sidebar-wrapper">
			<div class="side-top">
				...
				<ul class="sidebar-nav">
					...
					<li><a class="active" href="transfer_money.php">View all customers</a></li>
            ...
            <div class="row">
                <div class="col">
                    ...
                    <table class="table table-hover table-sm table-striped table-condensed table-bordered">
                        <thead>
                            ...
                            <th scope="col" class="text-center py-2">IFSC-code</th>    
                ...
                ?>
                    <tr>
                        ...
                        <td class="py-2"><?php echo $rows['ifsc-code']?></td>
